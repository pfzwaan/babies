...
@section('title', $archiveHeading . ' - Babynamengids')
...
@section('main-content')
    ...
    <section>
        <div class="max-w-[1125px]">
            ...
            <h3 class="mt-3 text-[30px] font-bold leading-[1.02] text-[#353535] lg:text-[55px] lg:leading-[50px]" style="font-family:Outfit,sans-serif;">{{ $archiveHeading }}</h3>
    ...
    <section>
        <img src="{{ asset('img/babies/seo-crown.svg') }}" alt="" aria-hidden="true" class="h-[32px] w-[39px] lg:h-[41px] lg:w-[50px]" />
        <h3 class="mt-3 text-[30px] font-bold leading-[1.02] text-[#353535] lg:text-[55px] lg:leading-[50px]" style="font-family:Outfit,sans-serif;">Over {{ $archiveHeading }}</h3>
        ...
        <p class="mt-5 text-[17px] leading-[1.8] text-[#353535] lg:text-[20px] lg:leading-[35px]">Binnen {{ strtolower($archiveHeading) }} kun je verschillende richtingen ontdekken: van bekend en tijdloos tot opvallend en origineel.</p>
    </section>
@endsection
